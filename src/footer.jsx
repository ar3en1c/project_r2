            ...
            <footer className="footer">
                ...
                <div className="f3fs">
                    ...
                    <div className="f3fs-about">
                        انتقام جویان وب سایتی است که جدیدترین فیلم ها و سریال های جهان را به شما نشان می دهد. ما از سال 2023 فعالیت می کنیم و متعهد هستیم که بهترین تجربه ممکن را برای کاربران خود فراهم کنیم.

                        وب سایت ما برای استفاده و پیمایش آسان است. ما طیف گسترده ای از فیلم ها و سریال ها را برای انتخاب داریم و مدام در حال اضافه کردن محتوای جدید هستیم. ما همچنین ویژگی‌های مختلفی را ارائه می‌کنیم تا تجربه تماشای شما را حتی بهتر کنیم، مانند تریلرها، بررسی‌ها و فهرست بازیگران.

                        ما علاقه زیادی به فیلم ها و سریال ها داریم و می خواهیم عشق خود را به این داستان های شگفت انگیز با جهان به اشتراک بگذاریم. ما معتقدیم که همه باید فرصت تجربه جادوی سینما را داشته باشند و متعهد به تحقق آن هستیم.

                        ماموریت ما

                        ماموریت ما ارائه بهترین تجربه ممکن در هنگام تماشای فیلم و سریال است. ما می‌خواهیم یافتن محتوای مورد نظر را برای کاربرانمان آسان کنیم و می‌خواهیم اطلاعاتی را که برای تصمیم‌گیری آگاهانه در مورد تماشای تماشای نیاز دارند در اختیار آنها قرار دهیم.

                        ما دائماً برای بهبود وب سایت و خدمات خود تلاش می کنیم و همیشه به دنبال راه های جدیدی برای بهبود تجربه کاربران خود هستیم. ما معتقدیم که بهترین راه برای انجام این کار این است که به کاربران خود گوش دهیم و به نظرات آنها پاسخ دهیم.

                        ارزش های ما

                        ما به قدرت داستان گویی اعتقاد داریم و معتقدیم فیلم ها و سریال ها می توانند تاثیر مثبتی بر زندگی مردم داشته باشند. ما متعهد هستیم که به کاربران خود محتوای باکیفیت ارائه دهیم که آنها را سرگرم، آموزش و الهام بخشد.

                        ما همچنین به اهمیت جامعه اعتقاد داریم و می خواهیم فضایی ایجاد کنیم که کاربران ما بتوانند با یکدیگر ارتباط برقرار کنند و عشق خود را به فیلم ها و سریال ها به اشتراک بگذارند. ما معتقدیم که با همکاری یکدیگر می توانیم دنیا را به مکانی بهتر تبدیل کنیم.

                        از اینکه از انتقام جویان دیدن کردید متشکرم. امیدواریم از اقامتتان لذت ببرید!
                    </div>
                </div>
                <div className="f4fs">
                ...
                <div className="f5fs">
                    ...
                    <div className="f5fs-logo">
                        ...
                        <a href="https://github.com/ar3en1c/project_r2" target="_blank" rel="noreferrer">
